...
```
git remote set-url origin https://github.com/danroscigno/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/danroscigno
cd ${GOPATH}/github.com/danroscigno
git clone https://github.com/danroscigno/lsbeat
```
